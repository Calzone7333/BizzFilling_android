        ...
        if (btnSignup != null) {
            btnSignup.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        if (etFullName == null || etEmail == null || etPhone == null || etPassword == null) {
                        ...
                        if (fullName.isEmpty() || email.isEmpty() || phone.isEmpty() || password.isEmpty()) {
                            ...
                            if (!isNetworkAvailable()) {
                                Toast.makeText(SignupActivity.this, "No Internet Connection. Please check your network.", Toast.LENGTH_LONG).show();
                                return;
                            }
